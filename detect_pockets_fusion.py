...
class GeoPredictor:
    ...
    def __init__(self, pdb_file, grid_spacing=0.5, dog_threshold_percentile=99,
                 eps=0.8, min_samples=10, residue_distance=4.0,
...
def main():
    ...
    try:
        predictor = GeoPredictor(
            ...
            min_samples=10,               # Fixed DBSCAN min_samples value.
            residue_distance=4.0,          # Distance threshold for residue evaluation (Aº).
